...
typedef enum {
    ...
    //USART_DMX_STATE_RDM = 3,
    USART_DMX_STATE_Msk = 3,

    USART_PORT_STATE_Tx = (0 << 5),
    USART_PORT_STATE_Rx = (1 << 5),
    USART_PORT_STATE_Msk = (1 << 5),

    USART_STATE_NewInput = (1 << 6),
    USART_STATE_Break = (1 << 7),

    USART_MODE_INPUT = (1 << 8),
    USART_MODE_OUTPUT = (0 << 8),
    USART_MODE_MSK = (1 << 8),
} USART_DMX_State;
